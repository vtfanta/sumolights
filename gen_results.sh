...
for i in {1..1}
do
    # python run.py -sim pub_test -demand custom -n 1 -tsc maxpressure -mode test -gmin 5 
    python run.py -sim grid -demand custom -n 1 -tsc maxpressure -mode test -gmin 5 
